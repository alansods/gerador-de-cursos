...
/* build-hook-start *//*00001*/try { require('/Users/alansantos/.cursor/extensions/wallabyjs.console-ninja-1.0.488-universal/out/buildHook/index.js').default({tool: 'next.js', checkSum: '20bdc5d38afe79e9bc4f46U1JNBUoCAgJXVg5aUVgBVVBQDQJW', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/alansantos/.cursor/extensions/wallabyjs.console-ninja-1.0.488-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20bdc5d38afe79e9bc4f46U1JNBUoCAgJXVg5aUVgBVVBQDQJW', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"16.0.1"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
    ...
    await new Promise((resolve)=>{
        server.on('listening', async ()=>{
            ...
            if (nodeDebugType) {
                ...
                const isEphemeral = (0, _utils.isDebugAddressEphemeral)();
                _log.info(`the --${nodeDebugType} option was detected` + (isEphemeral ? '' : `, the Next.js router server should be inspected at ${formattedDebugAddress}.`));
            }
