...
const originalDragItems: DragItem[] = [
  {
    id: "pote-vidro",
    text: "Pote de geleia de vidro",
    image: "/assets/images/unidade-1/vidro.png",
    correctPosition: 1,
    type: "Embalagem Primária",
  },
  {
    id: "caixa-divisoes",
    text: "Caixa de papelão com divisórias",
    image: "/assets/images/unidade-1/papelao.png",
    correctPosition: 2,
    type: "Embalagem Secundária",
  },
  {
    id: "caixa-grande",
    text: "Caixa de papelão grande",
    image: "/assets/images/unidade-1/papelao.png",
    correctPosition: 3,
    type: "Embalagem Terciária",
  },
  {
    id: "palete-madeira",
    text: "Palete de madeira",
    image: "/assets/images/unidade-1/madeira.png",
    correctPosition: 4,
    type: "Embalagem Quaternária",
  },
  {
    id: "plastico-filme",
    text: "Plástico filme",
    image: "/assets/images/unidade-1/plastico.png",
    correctPosition: 5,
    type: "Fixação da Carga",
  },
];
...
const dropZones: DropZone[] = [
  {
    id: "posicao-1",
    title: "1ª Camada",
    description: "Embalagem Primária",
    position: 1,
    correctItem: "pote-vidro",
  },
  {
    id: "posicao-2",
    title: "2ª Camada",
    description: "Embalagem Secundária",
    position: 2,
    correctItem: "caixa-divisoes",
  },
  {
    id: "posicao-3",
    title: "3ª Camada",
    description: "Embalagem Terciária",
    position: 3,
    correctItem: "caixa-grande",
  },
  {
    id: "posicao-4",
    title: "4ª Camada",
    description: "Embalagem Quaternária",
    position: 4,
    correctItem: "palete-madeira",
  },
  {
    id: "posicao-5",
    title: "5ª Camada",
    description: "Fixação da Carga",
    position: 5,
    correctItem: "plastico-filme",
  },
];
...
export function DragDropActivity() {
  ...
  const checkAnswers = () => {
    ...
    if (percentage === 100) {
      setFeedback("Parabéns! Você montou a sequência correta de embalagens!");
      setIsCompleted(true);
    } else {
      setFeedback(
        `Você acertou ${correct} de ${total} posições. Revise a sequência correta das embalagens.`
      );
    }
      ...
      <div className="w-full max-w-6xl mx-auto p-4 space-y-6">
        <div className="text-center mb-6">
          <h3 className="text-xl font-bold text-foreground mb-2">
            Simulação de Embalagens: Sequência Correta
          </h3>
          <p className="text-sm text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 px-3 py-1 rounded-full inline-block mb-4">
            📦 Arraste os elementos para montar a sequência correta de
            embalagens
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-yellow-700 dark:text-yellow-300 space-y-2">
                  <p>
                    <strong>Sequência correta:</strong> Comece com o produto
                    (pote de geleia), depois as embalagens de proteção e
                    transporte, e termine com a fixação no palete.
                  </p>
                  <p>
                    <strong>1ª:</strong> Pote de geleia (produto) →{" "}
                    <strong>2ª:</strong> Caixa com divisórias (proteção) →{" "}
                    <strong>3ª:</strong> Caixa grande (transporte) →{" "}
                    <strong>4ª:</strong> Palete (unitização) →{" "}
                    <strong>5ª:</strong> Plástico filme (fixação)
                  </p>
                </div>
              </div>
            </div>
