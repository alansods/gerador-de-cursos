...
function SortableItem({ item, isUsed }: { item: DragItem; isUsed: boolean }) {
  ...
  return (
    <div
      ...
      {...listeners}
    >
      <div className="w-[200px] h-[200px] rounded-lg border-2 border-gray-200 hover:border-blue-400 transition-colors overflow-hidden bg-white">
        <img
          src={item.image}
          alt={item.text}
  ...
  return (
    ...
    >
      <div className="text-center mb-2">
        <h4 className="font-bold text-sm text-gray-800">{zone.title}</h4>
      ...
      >
        {item ? (
          <div className="w-full h-full flex flex-col items-center justify-center relative">
            <div
              className={`w-full h-full rounded-lg border-2 overflow-hidden bg-white ${
                showFeedback
                  ? isCorrect
                    ? "border-green-500"
                    : isIncorrect
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto order-2 sm:order-2">
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto order-2"
      ...
      <DragOverlay>
        {activeItem ? (
          <Card
            className="p-3 bg-blue-100 border-blue-300 shadow-xl scale-110 rotate-2 select-none"
            style={{
              touchAction: "none",
              cursor: "grabbing",
            }}
          >
            <div className="w-[200px] h-[200px] rounded-lg border-2 border-blue-400 overflow-hidden bg-white">
              <img
