...
export function layoutPromptSection(layout: string | undefined, mode: ReadMode): string {
  ...
  no documento (quiz, matching, categorization, interactive-video) dentro da etapa do assunto
  ...
  quiz de 1 pergunta baseado apenas no conteúdo daquela etapa.`
      : `- Cada etapa deve terminar com ao menos uma atividade avaliada (quiz, matching ou
  categorization) baseada apenas no conteúdo daquela etapa. Neste layout, essa regra substitui
