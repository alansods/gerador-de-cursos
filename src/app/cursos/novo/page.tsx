...
export default function NovoCursoPage() {
  ...
  const [processingStep, setProcessingStep] = useState<
    'idle' | 'extracting' | 'generating' | 'done'
  >('idle')
  ...
  const handleGenerateWithAI = async (mode: 'auto' | 'markers' = 'auto') => {
    ...
    if (!text) {
      ...
      try {
        ...
        setValidationMessage({
          type: 'error',
          message: error instanceof Error ? error.message : 'Erro ao extrair texto',
        })
    ...
    try {
      ...
      if (!generateResponse.ok) {
        ...
        if (contentType && contentType.includes('application/json')) {
          ...
          throw new Error(
            `Erro ao gerar curso (${generateResponse.status}): ${text.substring(0, 100)}`
          )
        }
      }
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                Crie um novo curso manualmente ou gere automaticamente usando IA
              </p>
            </div>
          </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        />
                        {errors.titulo && (
                          <p className="text-sm text-red-600 dark:text-red-400">{errors.titulo}</p>
                        )}
                      </div>
                      <div className="space-y-2">
                        <label
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        rows={5}
                        className={errors.descricao ? 'border-red-500' : undefined}
                      />
                      {errors.descricao && (
                        <p className="text-sm text-red-600 dark:text-red-400">{errors.descricao}</p>
                      )}
                    </div>
                        ...
                        <div className="flex-1 space-y-3">
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-blue-800 dark:text-blue-300">
                              Envie um documento Word (.docx ou .doc) estruturado com o conteúdo do
                              curso. A IA irá processar o documento e criar automaticamente o curso
                              com unidades e conteúdo organizados.
                            </p>
                            <p className="text-sm text-blue-800 dark:text-blue-300 font-semibold">
                              ⚠️ A IA usa ESTRITAMENTE o conteúdo do seu documento. Ela não inventa
                              ou adiciona informações extras.
                            </p>
                      ...
                      <div className="flex gap-3">
                        <div className="flex-1 rounded-lg border border-purple-200 dark:border-purple-800 bg-purple-50 dark:bg-purple-950/30 p-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                            A IA lê o conteúdo e decide o melhor recurso para cada parte (accordion,
                            quiz, flipcard, etc.)
                          </p>
                          <Button
                            type="button"
                        ...
                        <div className="flex-1 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 p-3">
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                            Use ACCORDION_INICIO/FIM, QUIZ_INICIO/FIM e FLIPCARD_INICIO/FIM no
                            documento para controle preciso.
                          </p>
                          <Button
                            type="button"
